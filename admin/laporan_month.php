                            ...
                            <form action="<?= $_SERVER["PHP_SELF"]; ?>" method="GET">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <label class="col-form-label">:</label>
                                        <input type="text" name="tanggal_awal" id="reservationdate" class="form-control col-sm-2 ml-2" data-target="#reservationdate" data-toggle="datetimepicker" required></input>
                                        <label class="col-form-label ml-3" style="width:120px;"><i class="fas fa-calendar-check"> Tanggal Akhir</i></label>
                                        <label class="col-form-label">:</label>
                                        <input type="text" name="tanggal_akhir" id="reservationdate2" class="form-control col-sm-2 ml-2" data-target="#reservationdate2" data-toggle="datetimepicker" required></input>
                        ...
                        <div class="col-sm-12">
                            <div class="card card-outline card-success">
                                <div class="card-header">
                                    ...
                                    <a href="../print/print_bulanan?kelas=<?= $kelas ?>&tgl_awal=<?= $tanggal_awal ?>&tgl_akhir=<?= $tanggal_akhir ?>" target="blank"><button class="btn btn-success btn-xs float-right"><i class="fas fa-print"> Cetak Laporan </i></button></a>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <?php
                                                $query = mysqli_query($koneksi, "SELECT SUM(biaya) AS total FROM coba WHERE id_kelas = '$kelas' AND tanggal BETWEeN '" . $tanggal_awal . "' AND '" . $tanggal_akhir . "' AND status_pay = '1'");
